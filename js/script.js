...
function displayBookmark(index) {
    ...
    <tr class="border-bottom">
        ...
        <td class="text-center p-2"><a target="_blank" href="${bookmarks[index].url}"><button class="btn btn-success" type="button" id="visitBtn">Visit</button></a></td>
        <td class="text-center p-2"><button class="btn btn-danger" type="button" id="deleteBtn" onclick="deleteBookmark(${index})">Delete</button></td>
    </tr>
    `
